...
Want the absolute fastest setup? Check out [**`easy_install.md`**](./docs/easy_install.md) for one-line install commands that auto-detect your hardware and launch the client instantly.
